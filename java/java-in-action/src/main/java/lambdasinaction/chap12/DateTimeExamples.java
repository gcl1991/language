...
public class DateTimeExamples {
    ...
    private static void useDateFormatter() {
        ...
        DateTimeFormatter italianFormatter = DateTimeFormatter.ofPattern("d. MMM yyyy", Locale.CHINA);
    ...
    private static void useZone() {
        ...
        LocalDate date = LocalDate.of(2020, Month.APRIL, 6);
        ZonedDateTime zdt1 = date.atStartOfDay(romeZone);
        LocalDateTime dateTime = LocalDateTime.of(2020, Month.APRIL, 6, 12, 00);
        ...
        ZoneOffset romeZone2 = ZoneOffset.ofHours(8);
        LocalDateTime timeFromInstant = LocalDateTime.ofInstant(instant, romeZone);
        System.out.println(timeFromInstant);
        Instant instantFromDateTime = timeFromInstant.toInstant(romeZone2);
